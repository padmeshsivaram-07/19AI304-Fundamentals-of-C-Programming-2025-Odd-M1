...
int main() {
    ...
    char greeting[] = "Welcome to C language";

    
    printf("Integer Literal Examples:\n");
    printf("Count = %d\n", count);
    printf("Big Number = %ld\n\n", bigNumber);

    printf("Floating-point Literal Examples:\n");
    printf("Temperature = %.1f\n", temperature);
    printf("Distance = %.4lf\n\n", distance);

    printf("Character Literal Example:\n");
    printf("Symbol = %c\n\n", symbol);

    printf("String Literal Example:\n");
    printf("Greeting = %s\n", greeting);
